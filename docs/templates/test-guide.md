...
> Molde. Copiar para `docs/out/guia_teste_manual.md`. Preencher com dados **lidos do schema** e do
...
**Gerado com:** `docs/rules/build_test_guide_on_demand.md` · **Nota:** ficheiro descartável — regenerar em vez de corrigir.
...
**Gate:** `ascii-align` → `md-align-tables` → `php tools/health-check.php` = **TUDO OK**
