...
**Âmbito:** `especificacao_mvp.md` (router) e `docs/spec/*.md` (N2).
**Não usar para:** relatórios, auditorias, mapas — têm regra própria (`docs/README.md`).
...
| Passo | Regra                                                                                                                            |
| :---- | :------------------------------------------------------------------------------------------------------------------------------- |
| 1     | **Número primeiro:** `RF-nn` / `RN-nn` / `D-nn` conforme §29.3 (§29 = `docs/spec/annex.md`). Nunca reutilizar um número extinto. |
...
Correr o GATE de `docs/README.md` (pipeline + `health-check` → `TUDO OK`).
