...
**Âmbito:** requisitos, decisões, regras, dados, API e entrega. O detalhe está **dividido por domínio** em `_dev/docs/spec/`.

> ⚠️ **PREVALÊNCIA:** em conflito, prevalece a especificação. O que é **operação** vive no `.clinerules`;
> as **ferramentas** em `_dev/tools/README.md`; os **testes** em `_dev/tests/README.md`. Não se duplica: **aponta-se**.
...
| **Editar ficheiros** (encoding seguro)      | `_dev/tools/README.md` §1    |
| **Estados** de um agendamento               | §20                          |
| Saber **o que falta fazer**                 | §24 · §25                    |
| **Instalar / importar**                     | §27                          |
| **Testar**                                  | `_dev/tests/README.md` · §28 |
| **Gerar documentação / mapas / relatórios** | `_dev/docs/README.md`        |
...
| Ferramentas: uso e catálogo             | `_dev/tools/README.md`                      | §1 · §2 · §3    |
| Testes: suites e execução               | `_dev/tests/README.md`                      | —               |
| Regras de documentação on-demand        | `_dev/docs/README.md` · `_dev/docs/rules/`  | —               |
| Guias e mapas de apoio (sob demanda)    | `_dev/docs/rules/` · `_dev/docs/templates/` | —               |
| Análise e auditoria (**não normativo**) | `_dev/mapaMentalMVP/*.md`                   | —               |
