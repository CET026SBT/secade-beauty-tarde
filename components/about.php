...
register_script('components/about');
?>
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.2s">
                <img class="img-fluid mb-3" src="img/about.jpg" alt="Sobre nós">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                if ($currentPage != "about.php") {
                    echo '<a class="btn btn-primary text-uppercase px-5 py-3" href="about.php">Mais sobre nós</a>';
                }
                ?>
            </div>
        </div>
