...
register_script('utils/formUtils');
register_script('utils/addressAutocomplete');
...
<div class="container-fluid px-0 d-flex flex-fill h-100">
    <div class="row align-items-center flex-fill m-0 w-100">
        <div class="col-xl-5 h-100 d-none d-xl-flex text-white position-relative align-items-center justify-content-center p-0 overflow-hidden">
            <img src="img/bg-login.png" alt="Imagem Lateral" class="auth-left-img">
        </div>
                ...
                <form id="registerForm" class="flex-fill">
                    <div class="form-steps-container">
                        <div class="form-step active">
                            ...
                            <button type="button" class="btn btn-primary w-100 py-2 m-0 fw-bold text-uppercase" onclick="register.form.nextStep()">Seguinte</button>
                        </div>
                        ...
                        <div class="form-step">
                            ...
                            <div class="d-flex gap-4">
                                <button type="button" class="btn btn-primary no-bg w-50 py-2 m-0 fw-bold text-uppercase" onclick="register.form.prevStep()">Voltar</button>
                                <button type="button" class="btn btn-primary w-50 py-2 m-0 fw-bold text-uppercase" onclick="register.form.submit()">Registar</button>
                            </div>
                        </div>
                    </div>
                </form>
