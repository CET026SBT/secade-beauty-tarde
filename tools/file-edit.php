 ...
 * adicionam BOM e convertem acentos em mojibake (ver tools/_common.php).
 ...
 *   php tools/file-edit.php replace notas.md spec.json --write
...
$cmd = posArg($p, 0);
if (!$cmd) {
    help("php tools/file-edit.php <show|write|replace|lines|grep> ...", [
        "show    <ficheiro> [inicio] [n] [--plain]",
