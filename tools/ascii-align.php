 ...
 *
 * Uso:
 *   php tools/ascii-align.php <ficheiro.md> [--write] [--verbose] [--boxes-only]
...
if (!$file) {
    help("php tools/ascii-align.php <ficheiro.md> [--write] [--verbose] [--boxes-only]", [
        "Dry-run por omissao; use --write para gravar.",
        "Ex.: php tools/ascii-align.php levantamento-requisitos.md --write",
