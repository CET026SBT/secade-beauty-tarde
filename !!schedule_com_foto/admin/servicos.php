...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id > 0) {
        ...
        save_service_photo($id, handle_image_upload($_FILES['imagem_servico'] ?? [], 'servico-' . $id));
    } else {
        $stmt = db()->prepare(
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" class="row">
            ...
            <div class="form-group col-md-6">
                <label>Imagem do servico</label>
                <input type="file" name="imagem_servico" class="form-control-file" accept="image/jpeg,image/png,image/gif,image/webp">
                <small class="form-text text-muted">Esta imagem aparece nos cartoes do site.</small>
            </div>
            <div class="form-group col-md-12">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <td style="min-width: 170px;">
                                    <?php if (!empty($service['foto'])): ?>
                                        <img src="../<?= e($service['foto']) ?>" class="img-fluid rounded mb-2" alt="<?= e($service['nome']) ?>">
                                    <?php else: ?>
                                        <div class="border rounded p-3 text-center text-muted mb-2">Sem imagem</div>
                                    <?php endif; ?>
                                    <input type="file" name="imagem_servico" class="form-control-file" accept="image/jpeg,image/png,image/gif,image/webp">
                                </td>
                                <td>
