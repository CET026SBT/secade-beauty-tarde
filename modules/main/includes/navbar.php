        ...
        <div class="collapse navbar-collapse p-3" id="navbarCollapse">
            <div class="navbar-nav me-auto">
                ...
                <?php if (!$isAuthPage): ?>
                    ...
                    <a href="<?= BASE_URL ?>/servicos" class="nav-item nav-link <?php echo ($currentPage == "serviceCategories.php" || $currentPage == "service" || $currentPage == "servicos") ? "active" : ""; ?>">Servicos</a>
            ...
            <?php if (!$isAuthPage): ?>
            <a href="<?= BASE_URL ?>/login" class="btn btn-sm btn-primary no-bg ms-lg-3 px-3 py-2">
