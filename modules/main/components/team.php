...
$teamMembers = [
    [
        "name" => "Lily Taylor",
        "role" => "Cabeleireiro",
        "image" => BASE_URL . "/modules/common/img/team-1.jpg",
        "delay" => "0.1s",
    ...
    [
        "name" => "Olivia Smith",
        "role" => "Manicura",
        "image" => BASE_URL . "/modules/common/img/team-2.jpg",
        "delay" => "0.3s",
    ...
    [
        ...
        "image" => BASE_URL . "/modules/common/img/team-3.jpg",
        "delay" => "0.5s",
        "social" => ["facebook" => "#", "instagram" => "#", "linkedin" => "#"]
    ],
    [
        ...
        "image" => BASE_URL . "/modules/common/img/team-4.jpg",
        "delay" => "0.7s",
        "social" => ["facebook" => "#", "instagram" => "#", "linkedin" => "#"]
    ]
];
