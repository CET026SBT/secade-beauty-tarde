        ...
        <div class="row g-0 align-items-center">
            ...
            <div class="col-lg-6">
                <div class="owl-carousel header-carousel animated fadeIn">
                    <img class="img-fluid" src="<?= BASE_URL ?>/modules/common/img/hero-slider-1.jpg" alt="">
                    <img class="img-fluid" src="<?= BASE_URL ?>/modules/common/img/hero-slider-2.jpg" alt="">
                    <img class="img-fluid" src="<?= BASE_URL ?>/modules/common/img/hero-slider-3.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
