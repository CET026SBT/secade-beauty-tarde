...
**Saída:** `dev/docs/out/guia_teste_manual.md` (descartável; regenerável a qualquer momento).
**Não confundir com:** testes automatizados — esses são `dev/tests/` (`dev/tests/README.md`).
...
| Preciso de…           | Ler                                                                   |
| :-------------------- | :-------------------------------------------------------------------- |
| o que o sistema faz   | `dev/docs/spec/requirements.md` (§4) · `operations.md` · `booking.md` |
| regras e estados      | `dev/docs/spec/booking.md` (§8, §9, §20) · `finance.md`               |
| o que já está testado | `dev/tests/README.md` · §26 (`delivery.md`)                           |
| arrancar do zero      | `dev/docs/spec/delivery.md` §27 (instalação/importação)               |
...
Seguir `dev/docs/templates/test-guide.md`. Um guia é aceitável quando:
...
| Passo | Comando                                                  |
| :---- | :------------------------------------------------------- |
| 1     | `php dev/tools/ascii-align.php <f> --write` (SQL/blocos) |
| 2     | `php dev/tools/md-align-tables.php <f> --write`          |
| 3     | `php dev/tools/health-check.php` → **TUDO OK**           |

UTF-8 sem BOM · CRLF · escrever por `dev/tools/file-edit.php` ou via .NET.
