...
**Fora da hierarquia (não normativos):** `dev/mapaMentalMVP/*` (análise, auditorias e guias) e `README.md`
(instalação). O `dev/tests/README.md` é a autoridade sobre **como testar** e o `dev/tools/README.md` sobre o
