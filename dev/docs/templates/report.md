...
> Molde. Copiar para `dev/docs/out/<assunto>.md`. Preencher; apagar o que não se aplica.
...
**Natureza:** apoio (não normativo) — autoridade: `especificacao_mvp.md` + `dev/docs/spec/`
...
**Gate:** pipeline + `php dev/tools/health-check.php` → `TUDO OK`
