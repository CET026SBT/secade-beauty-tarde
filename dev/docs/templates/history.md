...
> Molde. Copiar para `dev/docs/out/historico_<assunto>.md`. Preencher com o que o Git devolver; apagar o que
...
**Reconstruído com:** `dev/docs/rules/build_history_on_demand.md` · **Natureza:** derivado do Git — **descartável**
...
**Onde vive hoje:** `<<dev/docs/spec/xx.md §N>>` — *"<<texto atual, curto>>"*
...
**Gate:** `md-align-tables` → `ascii-align` → `php dev/tools/health-check.php` = **TUDO OK**
