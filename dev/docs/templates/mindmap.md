...
> Molde. Copiar para `dev/docs/out/<assunto>.md`. Um diagrama **por ficheiro**, ligado ao código real.
...
**Gate:** `php dev/tools/ascii-align.php <f> --write` → `php dev/tools/health-check.php` → `TUDO OK`
