 ...
 *
 * Uso:
 *   php dev/tools/ascii-align.php <ficheiro.md> [--write] [--verbose] [--boxes-only]
...
if (!$file) {
    help("php dev/tools/ascii-align.php <ficheiro.md> [--write] [--verbose] [--boxes-only]", [
        "Dry-run por omissao; use --write para gravar.",
        "Ex.: php dev/tools/ascii-align.php levantamento-requisitos.md --write",
