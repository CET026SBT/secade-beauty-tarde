 ...
 *
 * Uso:
 *   php dev/tools/encoding-check.php [ficheiro|pasta ...] [--ext=php,sql,js,md,css,html]
 *   php dev/tools/encoding-check.php                       (analisa o projeto inteiro)
 *
...
out("");
out("Corrigir com: php dev/tools/encoding-fix.php <ficheiro...> --write");
exit(1);