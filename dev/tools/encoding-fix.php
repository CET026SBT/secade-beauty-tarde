 ...
 *
 * Uso:
 *   php dev/tools/encoding-fix.php <ficheiro|pasta ...> [--write] [--eol=CRLF|LF] [--bom-only]
...
if (!$targets) {
    help("php dev/tools/encoding-fix.php <ficheiro|pasta ...> [--write] [--eol=CRLF|LF] [--bom-only]", [
        "Sem --write corre em dry-run.",
        "Ex.: php dev/tools/encoding-fix.php especificacao_mvp.md --write",
        "Ex.: php dev/tools/encoding-fix.php . --write --include-tools",
    ]);
}
