 ...
 *
 * Uso:
 *   php dev/tools/md-align-tables.php <ficheiro.md> [--write]
...
if (!$file) {
    help("php dev/tools/md-align-tables.php <ficheiro.md> [--write]", [
        "Dry-run por omissao; use --write para gravar.",
        "Ex.: php dev/tools/md-align-tables.php especificacao_mvp.md --write",
    ]);
}
