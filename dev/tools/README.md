...
> 📍 **Onde vive esta pasta.** Em **`dev/tools/`** — a umbrella **`dev/`** reúne o que **não é produto**
...
php dev/tools/file-edit.php show ficheiro.md 100 40
php dev/tools/file-edit.php replace ficheiro.md spec.json --write
...
php dev/tools/health-check.php

# Detetar problemas de encoding (aceita exceções conhecidas)
php dev/tools/encoding-check.php
php dev/tools/encoding-check.php especificacao_mvp.md
php dev/tools/encoding-check.php --ext=php,sql
php dev/tools/encoding-check.php --ignore=ficheiro_legado.sql

# Reparar BOM / mojibake  +  converter UTF-16 -> UTF-8 (dry-run -> gravar)
php dev/tools/encoding-fix.php especificacao_mvp.md
php dev/tools/encoding-fix.php especificacao_mvp.md --write
php dev/tools/encoding-fix.php . --write
php dev/tools/encoding-fix.php dump_legado.sql        # deteta UTF-16 e propõe conversão
...
php dev/tools/md-wrap-tables.php especificacao_mvp.md            # dry-run (diz quantas tabelas excedem 200 colunas)
php dev/tools/md-wrap-tables.php especificacao_mvp.md --write
php dev/tools/md-wrap-tables.php relatorio.md --write --max=160 --min=10 --verbose

# Alinhar tabelas markdown de um .md
php dev/tools/md-align-tables.php especificacao_mvp.md
php dev/tools/md-align-tables.php especificacao_mvp.md --write

# Verificar a uniformidade das tabelas (todas as linhas do bloco com a mesma largura)
php dev/tools/widthcheck.php especificacao_mvp.md
php dev/tools/widthcheck.php relatorio.md 260      # limite explicito (ignora o pragma do ficheiro)

# Juntar tabelas partidas por uma linha em branco (dry-run -> gravar)
php dev/tools/md-join-tables.php doc.md
php dev/tools/md-join-tables.php doc.md --write

# Nivelar tabelas ASCII / diagramas dentro de code fences
php dev/tools/ascii-align.php dev/docs/spec/booking.md
php dev/tools/ascii-align.php dev/docs/spec/booking.md --write
php dev/tools/ascii-align.php diagrama.md --write --boxes-only    # só boxes '+---+'
php dev/tools/ascii-align.php diagrama.md --verbose               # diagnostico por linha

# Verificar estrutura dos .md
php dev/tools/md-verify.php
php dev/tools/md-verify.php especificacao_mvp.md

# Ler / escrever com seguranca
php dev/tools/file-edit.php show especificacao_mvp.md 1105 40
php dev/tools/file-edit.php grep "funcionario_categoria"
php dev/tools/file-edit.php grep "admin-service-" --ext=php --ignore-case
php dev/tools/file-edit.php replace doc.md spec.json --write
php dev/tools/file-edit.php lines doc.md 12 18 novo.txt --write
```
...
continua a sobrepor-se). O pragma só conta se estiver **no topo do ficheiro** (primeiras 10
linhas): assim, um ficheiro que apenas **documente** o pragma — como este README — não vê o seu
limite alterado por o citar num exemplo.
...
4. Validar com `php -l` e correr `php dev/tools/health-check.php` no projeto.
