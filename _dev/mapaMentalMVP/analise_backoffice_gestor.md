...
`_dev/mapaMentalMVP/Menu APOIO 3.docx` (estrutura de menus do software de contabilidade + 3 capturas com o
**mapa de células** do balancete) e `_dev/mapaMentalMVP/CUSTOS RH 2.xlsx` (folha de cálculo do custo de pessoal:
...
|      | — §F.7                                        | `zlib`+`gzinflate` leem o ZIP (**12/12** e **15/15** entradas)   | aceite, ➕ `_dev/tools/xlsx-read.php`   | **só se aprovado**, acrescentar o leitor como        |
|      |                                               |                                                                  | (só                                     |                                                      |
|      |                                               |                                                                  | depois de decisão)                      | ferramenta de `_dev/tools/` (§12 do `.clinerules`)   |
...
> branch nenhuma (a única ferramenta que se propõe criar é `_dev/tools/xlsx-read.php`, e ** só depois de decisão**).
