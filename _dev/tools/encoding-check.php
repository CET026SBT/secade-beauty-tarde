 ...
 *
 * Uso:
 *   php _dev/tools/encoding-check.php [ficheiro|pasta ...] [--ext=php,sql,js,md,css,html]
 *   php _dev/tools/encoding-check.php                       (analisa o projeto inteiro)
 *
...
out("");
out("Corrigir com: php _dev/tools/encoding-fix.php <ficheiro...> --write");
exit(1);