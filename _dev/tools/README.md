...
php _dev/tools/file-edit.php show ficheiro.md 100 40
php _dev/tools/file-edit.php replace ficheiro.md spec.json --write
...
php _dev/tools/encoding-check.php
php _dev/tools/encoding-check.php especificacao_mvp.md
php _dev/tools/encoding-check.php --ext=php,sql
php _dev/tools/encoding-check.php --ignore=ficheiro_legado.sql

# Reparar BOM / mojibake  +  converter UTF-16 -> UTF-8 (dry-run -> gravar)
php _dev/tools/encoding-fix.php especificacao_mvp.md
php _dev/tools/encoding-fix.php especificacao_mvp.md --write
php _dev/tools/encoding-fix.php . --write
php _dev/tools/encoding-fix.php dump_legado.sql        # deteta UTF-16 e propõe conversão
...
php _dev/tools/md-wrap-tables.php especificacao_mvp.md            # dry-run (diz quantas tabelas excedem 200 colunas)
php _dev/tools/md-wrap-tables.php especificacao_mvp.md --write
php _dev/tools/md-wrap-tables.php relatorio.md --write --max=160 --min=10 --verbose

# Alinhar tabelas markdown de um .md
php _dev/tools/md-align-tables.php especificacao_mvp.md
php _dev/tools/md-align-tables.php especificacao_mvp.md --write

# Verificar a uniformidade das tabelas (todas as linhas do bloco com a mesma largura)
php _dev/tools/widthcheck.php especificacao_mvp.md
php _dev/tools/widthcheck.php relatorio.md 260      # limite explicito (ignora o pragma do ficheiro)

# Juntar tabelas partidas por uma linha em branco (dry-run -> gravar)
php _dev/tools/md-join-tables.php doc.md
php _dev/tools/md-join-tables.php doc.md --write

# Nivelar tabelas ASCII / diagramas dentro de code fences
php _dev/tools/ascii-align.php _dev/docs/spec/booking.md
php _dev/tools/ascii-align.php _dev/docs/spec/booking.md --write
php _dev/tools/ascii-align.php diagrama.md --write --boxes-only    # só boxes '+---+'
php _dev/tools/ascii-align.php diagrama.md --verbose               # diagnostico por linha

# Verificar estrutura dos .md
php _dev/tools/md-verify.php
php _dev/tools/md-verify.php especificacao_mvp.md

# Ler / escrever com seguranca
php _dev/tools/file-edit.php show especificacao_mvp.md 1105 40
php _dev/tools/file-edit.php grep "funcionario_categoria"
...
4. Validar com `php -l` e correr `php _dev/tools/health-check.php` no projeto.
