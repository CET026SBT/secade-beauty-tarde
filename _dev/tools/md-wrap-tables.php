 ...
 *
 * Uso:
 *   php _dev/tools/md-wrap-tables.php <ficheiro.md> [--write] [--max=200] [--min=8] [--verbose]
...
if (!$file) {
    help("php _dev/tools/md-wrap-tables.php <ficheiro.md> [--write] [--max=200] [--min=8] [--verbose]", [
        "Dry-run por omissao; use --write para gravar.",
        "Ex.: php _dev/tools/md-wrap-tables.php duvidas.md --write",
...
if ($maxArg === null) {
    ...
    // apenas DOCUMENTE o pragma (ex.: _dev/tools/README.md) nao pode ver o seu limite
