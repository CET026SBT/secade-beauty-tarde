...
| 3   | atual: router + `_dev/docs/spec/` **+** `_dev/docs/rules`/`_dev/docs/templates`                                                                         | disco                         |
...
1. `--follow` **exige um só** pathspec e **para** quando o ficheiro é novo: em `_dev/docs/spec/booking.md`
...
Pipeline + `php _dev/tools/health-check.php` → **TUDO OK** (`_dev/docs/README.md`). Sem BOM, CRLF.
