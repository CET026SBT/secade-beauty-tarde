...
| Preciso de…           | Ler                                                                    |
| :-------------------- | :--------------------------------------------------------------------- |
| o que o sistema faz   | `_dev/docs/spec/requirements.md` (§4) · `operations.md` · `booking.md` |
| regras e estados      | `_dev/docs/spec/booking.md` (§8, §9, §20) · `finance.md`               |
...
Seguir `_dev/docs/templates/test-guide.md`. Um guia é aceitável quando:
...
| Passo | Comando                                                   |
| :---- | :-------------------------------------------------------- |
| 1     | `php _dev/tools/ascii-align.php <f> --write` (SQL/blocos) |
| 2     | `php _dev/tools/md-align-tables.php <f> --write`          |
| 3     | `php _dev/tools/health-check.php` → **TUDO OK**           |

UTF-8 sem BOM · CRLF · escrever por `_dev/tools/file-edit.php` ou via .NET.
